...
| WEB-SAVE-003    | Vitest                              | frozen schema-v2 fail-closed parsing/migration, schema-v3 allocation validation, explicit-only storage writes, backup fallback, interrupted-write safety                     | `src/tests/domain/save.test.ts`              |
