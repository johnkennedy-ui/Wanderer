...
/**
 * Released wanderer-web-v1 recipe. This implementation is append-only: future
 * procedural changes must add a new generator module rather than editing it.
 */
export const generateWandererWebV1Chunk: ChunkGenerator = (
  world,
  coordinate,
): ChunkRecipe => {
